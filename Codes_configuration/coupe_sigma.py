#Ce code permet la creationd 'une carte représentant une coupe de l'ocean avec représentation des niveaux sigma à une latitude donnée
...
# Parametres de la coordonnee sigma 
theta_s = 8.0
theta_b = 2.0
hc = 100.0
...
# Fonction de transformation de sigma en profondeur réelle
...
# Calcule la profondeur reelle z (m, negative) de chaque niveau s_rho, pour un vecteur/tableau de bathymetrie h. zeta (surface libre) est
...
# Extraction de la coupe à la latitude demandée
